...
class _PushMessagingExampleState extends State<PushMessagingExample> {
  ...
  void _showItemDialog(Map<String, dynamic> message) {
    var dialog = new SimpleDialog(title: new Text('Title'),
      children: <Widget>[_buildDialog(context, _itemForMessage(message))]);
  ...
  void initState() {
    ...
    _firebaseMessaging.configure(
      onMessage: (Map<String, dynamic> message) {
        ...
        var jsonval=new TextEditingValue.fromJSON(message);
        print("Json Value"+jsonval.toString());
